...
/**
 * This activity is used to generate a training file for the training process of libsvm.
 * It receives the path to the files generated by ActivityMarker and ActivityRegistrator
 * and pass them to TrainingGeneratorIntentService, then receives messages with the progress.
 * It finally show the percentage used of the file generated by ActivityRegistrator and an estimation 
 * of the Hz given by the sensor.
 * @author job
 *
 */
