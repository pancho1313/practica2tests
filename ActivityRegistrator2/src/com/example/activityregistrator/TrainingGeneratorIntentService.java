...
/**
 * This service generates a libsvm training/test file.
 * It divides the sensor file generated by ActivityRegistrator in states using
 * ActivityMarker's file, and calculating the vector of features for each
 * windowData. The parameters of how to generate the final file are in
 * assets/ActivityRegistrator.properties 
 * @author job
 *
 */
public class TrainingGeneratorIntentService extends IntentService {
	 ...
	 * get the input files and set parameters to initiate SVMTraining.generateTrainingFile
	 */
	@Override
